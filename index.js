...
var picks = {
	'I': [1,3,0,2,3,2,3,0,1,4,4,4,2,0,1,0,4,0,4,3,0],
	'O': [0,2,1,2,0,3,2,1,1,1,3,0,3,1,1,0,2,1,2,2,3,0,1,0,3,3],
	'E': [5,1,5,3,0,5,1,4,1,2,4,2,4,0,5,2,3,5,5,4,4,5,1,5,4,4,1,1,4,3,1,1,2,0,4,1,1,5,1,1],
	'Y': [1,0,1,0,1,1,1],
	'U': [1,0,2,0,2,0],
	'A': [1,0,4,2,3,2,1,1,4,2,0,1,3,4,2,0,4,3,4,3,0,4,2,3,4,2,4,1,0,1,2,2,0,0,2,0], // check all L and corner again
	...
	'N': [1,1,2,2,3,3,4,0,1,4,2,0,3,4,0,0,1,1,0,4],
